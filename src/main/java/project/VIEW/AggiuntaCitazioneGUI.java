...
public class AggiuntaCitazioneGUI extends JFrame {
	...
	public AggiuntaCitazioneGUI(Controller c, List<Materiale> listaMateriali, Materiale materialeCitante) {
		setTitle("Library managment system");
		setIconImage(Toolkit.getDefaultToolkit().getImage(AggiuntaCitazioneGUI.class.getResource("/GUI/libri.png")));
		setResizable(false);
