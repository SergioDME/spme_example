...
public class AggiuntaCategoriaNuovaGUI extends JFrame {

	private Controller controller;

	private JPanel contentPane;

	public AggiuntaCategoriaNuovaGUI(Controller c, Materiale materiale) {
		setResizable(false);
		...
		nuovaButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controller.openAggiuntaGerarchiaNuova(materiale);
				dispose();
			}
		});
		...
		esistenteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controller.openAggiuntaAGerarchiaEsistente(materiale);
				dispose();
			}
		});
