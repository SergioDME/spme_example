...
public class AggiuntaAGerarchiaEsistenteGUI extends JFrame {
	...
	public AggiuntaAGerarchiaEsistenteGUI(Controller c, List<Categoria> listaCategorie, Materiale materiale) {
		setResizable(false);
		...
		sceltaField.setToolTipText("La categoria scelta sar\u00E0 la supercategoria della categoria che inserir\u00E0 l'utente");
		...
		sceltaLabel.setBounds(10, 229, 127, 34);
			...
			public void actionPerformed(ActionEvent e) {
				for(Categoria categoria: listaCategorie) {
					if(categoria.getNome().equals(sceltaField.getText())) {
						controller.openAggiuntaCategoriaAGerarchia(materiale, categoria);
						dispose();
						return;
					}
				}
		...
		esciButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				dispose();
				controller.openAggiuntaCategoria(materiale);
			}
		});
		...
		imageLabel.setBounds(0, 0, 440, 315);
