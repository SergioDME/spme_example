...
public class AggiuntaCategoriaAGerarchiaGUI extends JFrame {
	...
	public AggiuntaCategoriaAGerarchiaGUI(Controller c, Materiale materiale, Categoria supercategoria) {
		setResizable(false);
