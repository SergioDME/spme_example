...
public class AggiuntaCategoriaEsistenteGUI extends JFrame {
	...
	public AggiuntaCategoriaEsistenteGUI(Controller c, List<Categoria> listaCategorie, Materiale materiale) {
		setResizable(false);
