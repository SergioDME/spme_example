...
public class AggiungiAGerarchiaEsistenteDaModificaGUI extends JFrame {
	...
	public AggiungiAGerarchiaEsistenteDaModificaGUI(Controller c, List<Categoria> listaCategorie, Materiale materiale) {
		setResizable(false);
			...
			public void actionPerformed(ActionEvent e) {
				for(Categoria categoria: listaCategorie) {
					if(categoria.getNome().equals(sceltaField.getText())) {
						controller.openAggiungiCategoriaAGerarchiaDaModifica(materiale, categoria);
						dispose();
						return;
					}
				}
