...
public class AggiuntaGerarchiaNuovaGUI extends JFrame {
	...
	public AggiuntaGerarchiaNuovaGUI(Controller c, Materiale materiale) {
		setResizable(false);
		...
		btnNewButton_1.setBounds(205, 98, 100, 23);
		...
		imageLabel.setBounds(0, 0, 316, 132);
